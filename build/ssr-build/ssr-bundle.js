...
var Home = function (_Component) {
	...
	Home.prototype.componentWillMount = function componentWillMount() {
		...
		__WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('https://api.dribbble.com/v1/shots?list=debuts&sort=recent&page=2&per_page=12&access_token=14d01cc0327dfd5900044a4b70978e4f90f24d5db82b38421e522cbd35f16d6d').then(function (res) {
			_this2.setState({ shots: res.data });
		}).catch(function (err) {
			console.log(err);
		});
	};
		...
		return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
				...
				__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
					'div',
					{ 'class': 'row' },
					this.state.shots.map(function (item, i) {
						return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
							'div',
							{ 'class': 'col-xs-12 col-sm-6 col-md-4', key: i },
							__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
								'div',
								{ 'class': __WEBPACK_IMPORTED_MODULE_1__style___default.a.box },
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
									'a',
									{ href: item.html_url, target: '_blank', 'class': __WEBPACK_IMPORTED_MODULE_1__style___default.a.title },
									__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('img', { src: item.images.hidpi || item.images.normal || item.images.teaser })
								),
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
									'a',
									{ href: item.html_url, target: '_blank', 'class': __WEBPACK_IMPORTED_MODULE_1__style___default.a.title },
								...
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
									'div',
									{ 'class': __WEBPACK_IMPORTED_MODULE_1__style___default.a.userprofile },
									__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('img', { src: item.user.avatar_url }),
									__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
										'a',
										{ target: '_blank', href: item.user.html_url },
										item.user.name
									)
								)
							)
...
module.exports = {"home":"home__MseGd","box":"box__1jIR2","title":"title__2Y8Va","userprofile":"userprofile__3lQIJ"};
